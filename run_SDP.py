...
sim.run(sims=100, matrix_name="T N Matrix 6", time = 3,cull = 'predator', N_cull= 6)
sim.run(sims=100, matrix_name="T N Matrix 7", time = 3,cull = 'predator', N_cull= 7)
sim.run(sims=100, matrix_name="T N Matrix 8", time = 3,cull = 'predator', N_cull= 8)
sim.run(sims=100, matrix_name="T N Matrix 9", time = 3,cull = 'predator', N_cull= 9)
sim.run(sims=100, matrix_name="T N Matrix 10", time = 3,cull = 'predator', N_cull= 10)
